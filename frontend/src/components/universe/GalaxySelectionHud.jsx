...
function resolvePrompt(navigationModel) {
  ...
  if (navigationModel.mode === "approach_active") {
    return {
      ...
      hint: isStarCore
        ? "Dvojklik otevírá samostatnou governance vrstvu. Esc tě vrátí o krok zpět."
  ...
  if (navigationModel.mode === "object_selected") {
    return {
      ...
      hint: isStarCore
        ? "Dvojklik otevře Star Core interior screen. Radar i scéna drží stejný selection focus."
