...
5. For UX-first or product-experience work, `docs/P0-core/governance/human-agent-alignment-protocol-v1.md` is the mandatory interpretation layer above normal block execution.
