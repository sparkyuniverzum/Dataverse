...
Depends on: `docs/P0-core/contracts/visual-builder-context-contract-v1.md`, `docs/P0-core/contracts/visual-builder-state-machine-v1.md`, `docs/P1-exec/direction/planet-civilization-domain-canonical-v1.md`, `frontend/src/components/universe/WorkspaceSidebar.jsx`
