...
- Canonical domain language and semantics are defined in `docs/P0-core/contracts/semantic-constitution-v1.md`.
...
- Complete method/path freeze list is tracked in `docs/P0-core/baselines/api-v1-openapi-baseline-v1.json` (`method_path_signatures`).
