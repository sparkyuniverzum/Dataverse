...
Depends on: `docs/P0-core/contracts/api-v1.md`, `docs/P0-core/contracts/visual-builder-context-contract-v1.md`, `docs/P1-exec/direction/planet-civilization-delivery-canonical-v1.md`
