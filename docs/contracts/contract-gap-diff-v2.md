...
| Star physics baseline v2 | `docs/star-physics-contract-baseline-v2.json` | DONE | DONE (`tests/test_star_contract_baseline.py`) | DONE (`tests/test_star_core_integration_freeze.py::test_star_physics_profile_migration_and_limit_guard_gate`) | DONE (`starContract.test.js`) | revisit migrate gate once `/physics/profile/migrate` is implemented |
