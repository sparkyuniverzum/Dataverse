...
Overeni:
- Kontrola auditu: `docs/P1-exec/plans/service-maturity-matrix-v1.md`
...
Overeni:
- Kontrola souboru: `docs/P1-exec/plans/service-maturity-matrix-v1.md`
- Kontrola souboru: `docs/P1-exec/plans/backend-sprint-dod-checklist.md`
