...
def test_enrich_main_timeline_falls_back_when_calc_state_is_stale(monkeypatch) -> None:
    ...
    monkeypatch.setattr(rm_projection, "_load_calc_state_by_asteroid_id", fake_load_calc)
    monkeypatch.setattr(rm_projection, "_load_physics_state_by_asteroid_id", fake_load_physics)
